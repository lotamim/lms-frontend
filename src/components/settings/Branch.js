                                                ...
                                                <form onSubmit={this.onSubmitHandler.bind(this)}>
                                                    ...
                                                    <div className="row clearfix">
                                                        <div className="col-sm-6">
                                                            <label for="name" className="required">Branch Name</label>
                                                            <div className="form-group">
                                                                <div className="form-line">
                                                                    <input type="text" className="form-control" name="branchName" id="branchName"
                                                                        placeholder="" value={this.state.branchName} onChange={this.onChangeHandler.bind(this)} />
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div className="col-sm-6">
                                                            ...
                                                            <div className="form-group">
                                                                <div className="form-line">
                                                                    <input type="text" className="form-control" name="phone" id="phone"
                                                                        placeholder="" value={this.state.phone} onChange={this.onChangeHandler.bind(this)} />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                            ...
                                                            <div className="form-group">
                                                                <div className="form-line">
                                                                    <input type="text" className="form-control" name="email" id="email"
                                                                        placeholder="" value={this.state.email} onChange={this.onChangeHandler.bind(this)} />
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div className="col-sm-6">
                                                            ...
                                                            <div className="form-group">
                                                                <div className="form-line">
                                                                    <input type="text" className="form-control" name="contactPerson" id="contactPerson"
                                                                        placeholder="" value={this.state.contactPerson} onChange={this.onChangeHandler.bind(this)} />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                            ...
                                                            <div className="form-group">
                                                                <div className="form-line">
                                                                    <textarea rows="4" className="form-control no-resize"
                                                                        name="address" id="address" value={this.state.address} onChange={this.onChangeHandler.bind(this)}
